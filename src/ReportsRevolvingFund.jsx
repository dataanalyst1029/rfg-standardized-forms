    ...
    <div className="audit-view">
      ...
      <div className="admin-toolbar">
        <div className="admin-toolbar-title">
          <h2>Revolving Funds Records</h2>
          <p>View all revolving funds in the system.</p>
        </div>
        ...
        <table className="admin-table purchase-table">
          <thead>
            <tr>
              ...
              <th style={{ textAlign: "left" }}>Revolving Amount</th>
              ...
              <tr>
                <td colSpan={8} className="admin-empty-state">
                  {search || startDate || endDate
                    ...
                    : "No pending revolving funds found."}
                </td>
              </tr>
            ) : (
              ...
              visibleRequests.map((req) => (
                <tr key={req.id}>
                  ...
                  <td style={{ textAlign: "left" }}>
                    {Number(req.revolving_amount).toLocaleString("en-PH", {
                      style: "currency",
                      currency: "PHP",
                    })}
                  </td>
        ...
        <div className={`modal-overlay ${isClosing ? "fade-out" : ""}`}>
          <div className="admin-modal-backdrop" role="dialog" aria-modal="true">
            <div className="admin-modal-panel request-modal">
              ...
              {/* This form only displays read-only approver info now */}
              <form
              ...
              {/* FIXED: Removed the duplicated, original form block */}
            </div>
          </div>
        </div>
      )}
