      ...
      <main className="pr-main">
                ...
                <div className="pr-field">
                    ...
                    <input
                        ...
                        formData.cutoff_date
                            ? new Date(formData.cutoff_date).toLocaleDateString("en-US", {
                                year: "numeric",
                                month: "long",
                                day: "numeric",
                            })
        ...
        <section className="pr-items-card" id="purpose">
            <div className="pr-flex-container">
                ...
                <div><span>Deposit of Excess</span><input type="text" name="excess_deposit" /></div>
                <div><span>Date</span><input type="date" name="date_excess" /></div>
                <div><span>Acknowledgement Receipt No.</span><input type="text" name="ack_rcpt_no" /></div>
                <div>
                    <span>Amount</span>
                    <input
                    type="number"
              ...
              <div className="signature-details">
                <label htmlFor="prepared_by">
                  <input
                    type="text"
                    name="prepared_by"
                    value={formData.prepared_by || userData.name || ""}
                    onChange={handleChange}
                  />
                  <p>Requested by:</p>
                </label>
                <label htmlFor="submitted-signature" class="signature-by">
                  ...
                  <input
                    ...
                    value={formData.prepared_signature || userData.signature || ""}
                    onChange={handleChange}
                    readOnly
                  />
                  <p>Signature:</p>
